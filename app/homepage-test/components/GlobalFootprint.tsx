...
export default function GlobalFootprint() {
  ...
  return (
    <section
      id="global-footprint"
      className="relative flex w-full flex-col overflow-hidden bg-[var(--color-primary-black)] pt-8 pb-6 lg:pt-0 lg:pb-10 min-h-[calc(var(--vh)-var(--header-height))] lg:h-[calc(100vh-var(--header-height))]"
    >
      ...
      <div className="relative flex min-h-0 flex-1 flex-col lg:flex-row items-center px-4 lg:px-20">
        ...
        <div className="relative min-w-0 w-full lg:flex-1 max-lg:flex max-lg:flex-1 max-lg:items-center">
          ...
          <ComposableMap
            ...
            // Test-page tweak: taller viewBox + higher scale so the map
            // fills the section and no dead gap shows above/below it.
            width={800}
            height={440}
            projectionConfig={{
              scale: 102,
