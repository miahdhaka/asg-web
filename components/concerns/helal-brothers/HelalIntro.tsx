...
export default function HelalIntro() {
  return (
    ...
    >
      ...
      {/* Stat cards */}
      <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:mt-[1.33em] lg:grid-cols-5 lg:gap-[1.33em]">
        {stats.map((stat) => (
