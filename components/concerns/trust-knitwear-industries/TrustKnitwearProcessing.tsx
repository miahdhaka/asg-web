...
const slides = [
  {
    src: "/images/concerns/trust-knitwear-industries/processing-1.webp",
    alt: "Knitwear production line",
  },
  {
    src: "/images/concerns/trust-knitwear-industries/processing-2.webp",
    alt: "Dyeing and finishing operations",
  },
  {
    src: "/images/concerns/trust-knitwear-industries/processing-3.webp",
    alt: "Sewing and garment assembly",
  },
  {
    src: "/images/concerns/trust-knitwear-industries/processing-4.webp",
    alt: "Quality inspection and finishing",
  },
];

/**
 * "Trust Knitwear Processing Excellence" — heading over a full-bleed,
 * edge-to-edge looping strip of process photography.
 */
export default function TrustKnitwearProcessing() {
