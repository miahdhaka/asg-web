...
/**
 * Top band of the Trust Knitwear Industries concern page — company
 * logo, name, tagline, a "Visit website" gradient-outline button, then the
 * full-width hero photograph (Figma node 2604-31654).
 */
export default function TrustKnitwearHero() {
  return (
    <section
      id="trustknitwear-hero"
    ...
    >
      ...
      <div className="flex flex-col gap-6 px-4 pt-8 pb-8 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-[5em] lg:pt-[3.33em] lg:pb-[3.33em]">
        <div>
          <Image
            src="/images/concerns/trust-knitwear-industries/logo-trustknitwear.svg"
            alt="Trust Knitwear Industries Ltd. logo"
            width={151}
            height={45}
            priority
            quality={100}
        ...
        <a
          href="https://www.trustknitwear.com/index.html"
          target="_blank"
