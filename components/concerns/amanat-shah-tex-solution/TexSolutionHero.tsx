...
/**
 * Top band of the Amanat Shah Tex Solution concern page — company logo,
 * name, tagline, a "Visit website" gradient-outline button, then the
 * full-width hero photograph (Figma node 1692-10970).
 */
export default function TexSolutionHero() {
  return (
    <section
      id="tex-solution-hero"
    ...
    >
      ...
      <div className="flex flex-col gap-6 px-4 pt-8 pb-8 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-[5em] lg:pt-[3.33em] lg:pb-[3.33em]">
        <div>
          <Image
            src="/logo/sister-concern/tex-solution-clr.png"
            alt="Amanat Shah Tex Solution logo"
            width={152}
            height={45}
            priority
            quality={100}
          ...
          <p className="mt-1 text-xs text-neutral-800 sm:text-sm lg:mt-0 lg:text-[1em] lg:leading-[1.33]">
            Excellence in Textile Chemicals
          </p>
        </div>
