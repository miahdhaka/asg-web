...
/**
 * Top band of the Amanat Shah Weaving Processing concern page — company
 * logo, name, tagline, a "Visit website" gradient-outline button, then the
 * full-width hero photograph (Figma node 2604-31283).
 */
export default function WeavingHero() {
  return (
    <section
      id="weaving-hero"
    ...
    >
      ...
      <div className="flex flex-col gap-6 px-4 pt-8 pb-8 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-[5em] lg:pt-[3.33em] lg:pb-[3.33em]">
        <div>
          <Image
            src="/images/concerns/amanat-shah-weaving-processing/logo-weaving.svg"
            alt="Amanat Shah Weaving Processing Ltd. logo"
            width={87}
            height={45}
            priority
            quality={100}
        ...
        <a
          href="https://www.asg-bd.com/ASWPL.php"
          target="_blank"
