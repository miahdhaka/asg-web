...
function CapabilityCard({ card }: { card: (typeof cards)[number] }) {
  return (
    <div className="card-gradient-hover relative flex flex-col border border-[#F5F5F5] bg-white p-5 lg:w-[29.33em] lg:p-[2em]">
      <Image
        src="/images/concerns/amanat-shah-weaving-processing/icon-weaving.svg"
        alt=""
        width={50}
        height={50}
 ...
 * on the right (Figma node 2604-31283).
 */
export default function WeavingCapabilities() {
  return (
    <section
      id="weaving-capabilities"
