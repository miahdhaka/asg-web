...
const slides = [1, 2, 3, 4].map((n) => ({
  ...
  alt: "Yarn spinning and packaging at the Hazrat Amanat Shah Spinning Mills facility",
}));

/**
 * "Hazrat Amanat Shah Spinning Mills Processing Excellence" — heading over a
 * full-bleed, edge-to-edge looping strip of process photography
 * (~2.4 frames visible).
 */
export default function SpinningProcessing() {
